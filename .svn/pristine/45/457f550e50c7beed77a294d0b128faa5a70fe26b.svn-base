...
<script type="text/javascript">
    ...
    $(function() {
        ...
        /*
        {
            ...
            sortable : true,
            formatter : function(value, row, index) {
            	return value==null?'无图标':'<img alt="'+row.name+'头像" src="'+row.icon+'" style="width: 100px;height: 40px">';
                }
        },
        */
        {
...
function exportmapMark(){
	window.location.href="${path}/mapMark/exportmapMark?"+$("#mapMarkSearchForm").serialize();
}
</script>
            ...
            <table>
                <tr>
                    ...
                    <td>
                        ...
                        <a href="javascript:void(0);" class="easyui-linkbutton" data-options="iconCls:'fi-download',plain:true" onclick="exportmapMark();">导出</a>
                    </td>
                </tr>
            </table>
        </form>
