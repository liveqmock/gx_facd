    ...
    <form id="organizationAddForm" method="post">
        <table class="grid">
            ...
            <tr>
                <td>是否是子系统</td>
                <td colspan="3">
                    <select name="isSystem" class="easyui-combobox" data-options="width:140,height:29,editable:false,panelHeight:'auto'">
            ...
            <tr>
                <td>系统URL</td>
                <td colspan="3"><input name="systemAddress" style="width: 300px;"/></td>
            </tr>
