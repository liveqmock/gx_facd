...
public abstract class BaseController {
    ...
    public <T> Page<T> getPage(PageInfo pageInfo) {
    	return new Page<T>(pageInfo.getNowpage(),pageInfo.getSize());
    }
	...
	/**
	 * 
	 * @param msg 消息描述-userid
	 * @param type 0-pc,1-移动，2-Tv
	 * @param userid 用户id
	 */
	public void OpLog(String msg,int type,Long userid) {
	 ...
	 * @param uuid 用户uuid
	 */
	public void OpLog(String msg,int type,String uuid) {
		OperateLog l = new OperateLog();
		l.setMsg(msg);
		l.setTerrace(type);
		l.setType("log");
	 ...
	 * @param userid 用户id
	 */
	public void ErrorLog(Exception e, int type, Long userid) {
		OperateLog l = new OperateLog();
		l.setMsg(e.toString());
		l.setTerrace(type);
		l.setType("errot");
	 ...
	 * @param uuid 用户uuid
	 */
	public void ErrorLog(Exception e, int type, String uuid) {
		OperateLog l = new OperateLog();
		l.setMsg(e.toString());
		l.setTerrace(type);
		l.setType("errot");
