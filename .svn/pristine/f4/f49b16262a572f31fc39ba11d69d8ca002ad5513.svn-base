...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements IUserService {
    ...
    @Override
    public UserVo selectVoByUUID(String uuid) {
        return userMapper.selectUserVoByUUID(uuid);
    }
    ...
    @Override
    public boolean updateByUUID(User user) {
	...
	@Override
	public User selectByTV(String token) {
		EntityWrapper<User> wrapper = new EntityWrapper<User>();
		wrapper.eq("token",token);
	...
	public User selectByUUid(String uuid) {
		EntityWrapper<User> en = new EntityWrapper<>();
		en.eq("uuid", uuid);
