		...
		<form id="userAddForm" method="post" enctype="multipart/form-data" >
			<table class="grid">
				...
				<tr>
					...
					<td>用户类型</td>
					<td><select name="userType" class="easyui-combobox"
						data-options="width:140,height:29,editable:false,panelHeight:'auto'">
				...
				<tr>
					<td>部门</td>
					<td><select id="userAddOrganizationId" name="organizationId"
						style="width: 140px; height: 29px;" class="easyui-validatebox"
						data-options="required:true"></select></td>
					<td>角色</td>
					<td><select id="userAddRoleIds" name="roleIds"
				...
				<tr>
					<td>路段分配</td>
					<td>
					<select name="road" id="roadid" data-options="editable:false,valueField:'id', textField:'text',width:140,height:29" ></select>
					</td>
					<td>政治面貌</td>
					<td><select name="politics" id="politicsid">
				...
				<tr>
					<td>生日</td>
					<td>
                        <input onclick="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd'})" name="birthday" placeholder="点击选择时间" type="text"  id="datetime" />
                        </td>
					<td>家庭住址</td>
