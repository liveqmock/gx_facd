        ...
        <input type="hidden" name="info" id="infoid" >
            <table class="grid">
                <tr>
                    ...
                    <td>发布人</td>
                    <td><input name="publisher" type="text" placeholder="请输入发布人" class="easyui-validatebox span2" data-options="required:true" value=""></td>
                </tr> 
                <tr>
                    <td>公告类型</td>
                    <td><select name="type" > 
                ...
                <tr>
                    <td>展示时间</td>
                    <td><input name="showTime" placeholder="点击选择时间" onclick="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd HH:mm:ss'})" readonly="readonly" /></td>
                    <td>公告范围</td>
